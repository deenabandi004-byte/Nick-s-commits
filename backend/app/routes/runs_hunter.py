...
def run_free_tier_enhanced_optimized(job_title, company, location, user_email=None, user_profile=None, resume_text=None, career_interests=None, college_alumni=None, batch_size=None):
    ...
    try:
        ...
        email_results = batch_generate_emails(contacts=contacts, resume_text=resume_text, user_profile=user_profile, career_interests=career_interests, pre_parsed_user_info=(user_data or {}).get("resumeParsed"), resume_filename=user_resume_filename, signoff_config=None, auth_display_name=auth_display_name, warmth_data=warmth_data, uid=user_id)
