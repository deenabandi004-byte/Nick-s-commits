# Ready-to-Send Email to Google

Copy and paste this entire email as a reply to Google's verification email:
...
Thank you for reviewing our OAuth verification request. Please find below instructions on how to access and test the OAuth consent screen for our application.
