...
function getFaqData(a: Company, b: Company) {
  return [
    ...
    },
    {
      ...
      answer: `${a.name} is known for being ${a.culture}, while ${b.name} is known for being ${b.culture}. These cultural differences affect everything from day-to-day work to the recruiting process. Meetings with employees at both firms will give you the best sense of which environment fits your working style and career goals.`,
    },
    {
    ...
    <div className="min-h-screen w-full" style={{ fontFamily: "'DM Sans', system-ui, sans-serif", background: '#FFFFFF' }}>
      ...
      <section className="px-6 py-12" style={{ maxWidth: '800px', margin: '0 auto', borderTop: '1px solid #F1F5F9' }}>
        ...
        <p style={{ fontSize: '15px', lineHeight: 1.8, color: '#475569' }}>
          The best approach to networking at {a.name} is to start with junior employees who share a connection with you, such as alumni from your university. Focus on building genuine relationships through meetings rather than jumping straight to referral requests. {a.name} employees tend to respond well to outreach that is {a.industry === 'consulting' ? 'structured and shows clear thinking' : a.industry === 'investment-banking' ? 'brief, specific, and references their group or recent deals' : a.industry === 'tech' ? 'genuine, references specific products or teams, and shows technical curiosity' : 'thoughtful, specific, and demonstrates knowledge of their work'}.
        </p>
      </section>
      ...
      <section className="px-6 py-16" style={{ maxWidth: '800px', margin: '0 auto', borderTop: '1px solid #F1F5F9' }}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <Link to={`/meeting/${a.slug}`} style={{ display: 'block', padding: '20px', borderRadius: '12px', border: '1px solid #E2E8F0', background: '#fff', textDecoration: 'none', transition: 'border-color 0.15s ease' }} onMouseEnter={e => (e.currentTarget.style.borderColor = '#3B82F6')} onMouseLeave={e => (e.currentTarget.style.borderColor = '#E2E8F0')}>
            <p style={{ fontSize: '14px', fontWeight: 600, color: '#0F172A', marginBottom: '6px' }}>{a.name} Meeting Guide</p>
            <p style={{ fontSize: '13px', color: '#64748B', lineHeight: 1.5 }}>Prep questions and follow-up templates.</p>
          </Link>
          <Link to={`/meeting/${b.slug}`} style={{ display: 'block', padding: '20px', borderRadius: '12px', border: '1px solid #E2E8F0', background: '#fff', textDecoration: 'none', transition: 'border-color 0.15s ease' }} onMouseEnter={e => (e.currentTarget.style.borderColor = '#3B82F6')} onMouseLeave={e => (e.currentTarget.style.borderColor = '#E2E8F0')}>
            <p style={{ fontSize: '14px', fontWeight: 600, color: '#0F172A', marginBottom: '6px' }}>{b.name} Meeting Guide</p>
            <p style={{ fontSize: '13px', color: '#64748B', lineHeight: 1.5 }}>Prep questions and follow-up templates.</p>
          </Link>
